...
import { loadForbiddenComponent, loadNotFoundComponent, loadAuthComponent, loadVacationComponent, loadProfileComponent } from './shared/loaders/lazy-loaders';
...
export const routes: Routes = [
    ...
    { path: "profile", loadComponent: () => loadProfileComponent(), canActivate: [authGuard] },
